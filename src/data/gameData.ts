...
export const billionaires: Billionaire[] = [
  ...
  { name: "Jeff Bezos", netWorth: 241.0, source: "Amazon", industry: "Technology", city: "Miami", movedFrom: "Seattle, WA", movedYear: "2023", whyMoved: "Said he wanted to be closer to his parents", emoji: "📦" },
  ...
  { name: "Thomas Peterffy", netWorth: 73.3, source: "Interactive Brokers", industry: "Finance", city: "Palm Beach", movedFrom: "Greenwich, CT", movedYear: "2014", whyMoved: "Left after CT governor was re-elected — 'I was actually very mad'", emoji: "📈" },
  { name: "Ken Griffin", netWorth: 50.4, source: "Citadel", industry: "Finance", city: "Miami", movedFrom: "Chicago, IL", movedYear: "2022", whyMoved: "Cited 25 bullet holes in front of his Chicago building", emoji: "🏦" },
  ...
  { name: "Shahid Khan", netWorth: 14.3, source: "Flex-N-Gate / Jaguars", industry: "Auto/Sports", city: "Naples", movedFrom: "Urbana, IL", movedYear: "2014", whyMoved: "Never publicly explained the move", emoji: "🏈" },
  ...
  { name: "Robert Duggan", netWorth: 15.4, source: "Duggan Investments", industry: "Healthcare", city: "Miami", movedFrom: "Oakland, CA", movedYear: "~2016", whyMoved: "Moved after selling pharma company for $3.5B", emoji: "💊" },
  { name: "Josh Harris", netWorth: 11.0, source: "Apollo / 76ers / Commanders", industry: "Finance/Sports", city: "Miami Beach", movedFrom: "New York, NY", movedYear: "2021", whyMoved: "Bought mansion; shifted primary residence", emoji: "🏀" },
  { name: "Micky Arison", netWorth: 10.1, source: "Carnival Cruises", industry: "Travel", city: "Bal Harbour", movedFrom: "Born in FL (rare!)", movedYear: "N/A", whyMoved: "Only top billionaire who actually made fortune in FL", emoji: "🚢" },
...
export const spendingItems: SpendingItem[] = [
  ...
  { id: "college_tuition", name: "Full College Tuition", description: "Cover a year of in-state tuition and fees for one student (~$6,400)", costPerUnit: 0.0064, unit: "student", category: "education", emoji: "🎓" },
