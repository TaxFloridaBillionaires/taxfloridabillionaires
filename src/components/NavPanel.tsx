...
export const NavTrigger = ({ onOpen }: NavTriggerProps) => {
  ...
  return (
    <button
      ...
      className="fixed bottom-4 right-4 z-40 bg-gold text-background w-12 h-12 rounded-sm flex items-center justify-center shadow-lg shadow-gold/20 hover:brightness-110 transition-all"
    >
